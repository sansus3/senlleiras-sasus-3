<template>
  <div class="carrusel">
    ...
    <ul class="carrusel-images-galery">
      <li v-for="(item, index) in images" :key="index" :class="item.clases" @mousedown="prueba">
        <img
          class="carrusel__image"
          :src="item.url"
          :title="title"
          :alt="alt"
        />
    ...
    <!-- botones -->
    <a
      @click.prevent="turnLeft"
      href="#"
      class="carrusel__button carrusel__button--prev"
    >
      <i class="fas fa-chevron-circle-left"></i>
    </a>
    <a
      @click.prevent="turnRight"
      href="#"
      class="carrusel__button carrusel__button--next"
    >
