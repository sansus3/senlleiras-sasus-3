<template>
    <section class="geolocation">
        <div class="geolocation__field">
            <label for="latitud" class="form-label required">Latitude<span data-set="Campo obligatorio" class="text-danger">*</span></label>
            <input
                id="latitud"
                name="latitud"
        ...
        <div class="geolocation__field">
            <label for="longitude" class="form-label required">Lonxitude<span data-set="Campo obligatorio" class="text-danger">*</span></label>
            <input
                id="longitude"
                name="longitude"
