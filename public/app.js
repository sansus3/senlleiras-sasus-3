...
const btns = document.querySelectorAll(".div-carrusel-position li");

btns.forEach((element,index)=>{
    element.onclick = () => {
        limpiar();
        contador = index;
        puntosCarrusel[index].classList.add("posicionado")
        imagenesCarrusel[index].classList.add("carruselmostrado");
    }
});
